...
# ⚠️ Tato upravená verze přepisuje výchozí scénu pro spawn následných střel na `bullet-ashe.tscn`.
# Pokud používáte jiné postavy, budete chtít původní verzi `bullet.gd`.
@onready var _bullet_scene: PackedScene = preload("res://Scenes/bullet-ashe.tscn")
